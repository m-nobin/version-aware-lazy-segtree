...
they were generated from. Confirmatory data, when it exists, will live under
`bench/results/confirm/` and will never be mixed into these files.
...
| Raw manifest | 96 files; `bench/results/raw.sha256`; manifest SHA-256 `c8869bc7388dc3a8bd1d6ad95a3f792bbf9b5b4d4765f7b7b06007c43ea1bd81` |
...
- `raw/`: immutable campaign output, one file family per workload W1-W12 and
  ...
  captured again before every workload). Nothing here is ever edited or
  regenerated.
